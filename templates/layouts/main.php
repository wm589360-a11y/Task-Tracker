...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="/Task-Tracker/public/assets/css/style.css">
</head>
<body>
<!-- Navigation -->
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container">
        <a class="navbar-brand" href="/Task-Tracker/public/">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <?php if(isset($_SESSION['user_id'])): ?>
                    <li class="nav-item">
                        <a class="nav-link" href="/Task-Tracker/public/dashboard">
                            <i class="bi bi-speedometer2"></i> Dashboard
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/Task-Tracker/public/tasks">
                            <i class="bi bi-list-check"></i> Tasks
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/Task-Tracker/public/analytics">
                            <i class="bi bi-bar-chart-line"></i> Analytics
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/Task-Tracker/public/calendar">
                            <i class="bi bi-calendar3"></i> Calendar
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/Task-Tracker/public/gantt">
                            <i class="bi bi-bar-chart-steps"></i> Gantt
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/Task-Tracker/public/reports">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="expensesDropdown">
                            <li><a class="dropdown-item" href="/Task-Tracker/public/expenses">My Expenses</a></li>
                            <?php if(isset($_SESSION['user_role']) && $_SESSION['user_role'] === 'admin'): ?>
                                <li><a class="dropdown-item" href="/Task-Tracker/public/expenses/approvals">Approvals</a></li>
                            <?php endif; ?>
                            <li><a class="dropdown-item" href="/Task-Tracker/public/expenses/reports">Reports</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="timeDropdown">
                            <li><a class="dropdown-item" href="/Task-Tracker/public/time/my-time">My Time</a></li>
                            <?php if(isset($_SESSION['user_role']) && $_SESSION['user_role'] === 'admin'): ?>
                                <li><a class="dropdown-item" href="/Task-Tracker/public/time/timesheets">Timesheets</a></li>
                            <?php endif; ?>
                            <li><a class="dropdown-item" href="/Task-Tracker/public/time/reports">Reports</a></li>
                        </ul>
                    </li>
                    <?php
                    ...
                    ?>
                    <li class="nav-item">
                        <form method="POST" action="/Task-Tracker/public/time/punch" class="d-inline">
                    ...
                    <?php endif; } ?>
                    <li class="nav-item">
                        <a class="nav-link" href="/Task-Tracker/public/profile">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark dropdown-menu-end" aria-labelledby="settingsDropdown">
                            <li><a class="dropdown-item" href="/Task-Tracker/public/custom-fields">
                                <i class="bi bi-sliders me-2"></i>Custom Fields
                            </a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/Task-Tracker/public/logout">
                            <i class="bi bi-box-arrow-right"></i> Logout
                        </a>
                    </li>
                <?php else: ?>
                    <li class="nav-item">
                        <a class="nav-link" href="/Task-Tracker/public/login">
                            <i class="bi bi-box-arrow-in-right"></i> Login
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/Task-Tracker/public/register">
        ...
        <div class="alert alert-danger alert-dismissible fade show py-2 border-0" role="alert"
            ...
            <div class="d-flex align-items-center gap-2 flex-wrap">
                ...
                <?php foreach($overdueTasks as $ot): ?>
                    <a href="/Task-Tracker/public/tasks/view/<?php echo $ot['id']; ?>"
...
<!-- Custom JS -->
<script src="/Task-Tracker/public/assets/js/main.js"></script>
</body>
</html>